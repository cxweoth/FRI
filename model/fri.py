from model.merkle import Merkle 
from model.field import FieldElement
from model.polynomial import Polynomial, test_colinearity
...
class FRI:
    def __init__(self, offset, omega, initial_domain_length, expansion_factor, num_colinearity_tests):
        ...
        # expansion_factor:
        # num_colinearity_tests: query and run how many test on 3 points colinearity
        self.offset = offset
        self.omega = omega
    ...
    def commit(self, codeword, proof_stream, round_index=0):
        ...
        # for each round
        print("num_rounds", self.num_rounds())
    ...
    def verify(self, proof_stream, polynomial_values):
        ...
        # print(last_omega.inverse(), last_omega^(len(last_codeword)-1))
        # print(last_omega, last_omega.inverse())
